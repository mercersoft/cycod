      ...
      >
        ...
        <div className="px-6 py-6 space-y-3">
          ...
          <button
            ...
            className="w-full inline-flex items-center justify-center gap-3 rounded-lg border border-white/20 bg-white/10 px-4 py-3 transition opacity-50 cursor-not-allowed"
          >
            <MicrosoftIcon />
